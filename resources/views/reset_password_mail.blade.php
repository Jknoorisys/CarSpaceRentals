                                                                                    ...
                                                                                    <td class="r21-c" align="left">
                                                                                        <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r22-o" style="table-layout: fixed; width: 100%;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="left" valign="top" class="r24-i nl2go-default-textstyle" style="color: #392f65; font-family: Roboto,Arial,Helvetica,sans-serif; font-size: 16px; line-height: 1.5; word-break: break-word; padding-top: 5px; text-align: left;">
                                                                                                    <div>
                                                                                                        <p style="margin: 0;"><span style="color: #0a1717;">{{ $url_msg }}</span></p>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td align="left" valign="top" class="r24-i nl2go-default-textstyle" style="color: #392f65; font-family: Roboto,Arial,Helvetica,sans-serif; font-size: 16px; line-height: 1.5; word-break: break-word; padding-top: 5px; text-align: left;">
                                                                                                    <div>
                                                                                                        <a href="{{ $url }}" style="font-family: Inter;font-size:14px; color:#ffffff; background-color:#0a1717; padding: 10px 10px 10px 10px; border-radius:7px;"><span style="font-size: 16px; line-height: 55px; display: inline-block; ">{{ trans('msg.email.Reset Your Password') }}</span></a>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
