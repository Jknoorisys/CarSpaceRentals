    ...
    public function addLocationLine(Request $request)
    {
        ...
        try {
            ...
            if ($lane) {
                ...
                $laneData['plotDetails'] = DB::table('plots')->where([['location_id', '=', $location_id],['line_id', '=', $id]])->orderBy('plot_position')->get();
                return response()->json([
                    'status'    => 'success',
    ...
    public function getLineDetails(Request $request)
    {
        ...
        try {
            ...
            if (!empty($lineDetails)) {
                $lineDetails->plots = DB::table('plots')->where('line_id', '=', $line_id)->orderBy('plot_position')->get();
                return response()->json([
                    'status'    => 'success',
