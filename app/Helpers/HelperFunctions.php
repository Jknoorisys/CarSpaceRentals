...
use Illuminate\Support\Facades\Storage;
    ...
    function generateInvoicePdf($invoice) {
        ...
        $data1 = ['salutation' => __('msg.Dear'),'name'=> $invoice['dealer_name'], 'msg'=> trans('msg.stripe.This email serves to confirm the successful setup of your subscription with Us.'), 'msg1'=> trans('msg.stripe.We are delighted to welcome you as a valued subscriber and are confident that you will enjoy the benefits of Premium Services.'),'msg2' => trans('msg.stripe.Thank you for your trust!')];
